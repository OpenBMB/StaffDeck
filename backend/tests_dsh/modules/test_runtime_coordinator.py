...
from staffdeck_dsh.modules.kernel import RuntimeCoordinatorModule
...
def test_provider_runtime_coordinator_loop_opens_legacy_engine(module, db, monkeypatch):
    ...
    monkeypatch.setattr(agent_loop_mod, "get_settings", lambda: SimpleNamespace(dsh_enabled=False))
