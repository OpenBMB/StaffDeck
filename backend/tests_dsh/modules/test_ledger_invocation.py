...
from staffdeck_dsh.capabilities.ledger import InvocationLedger, LedgerEntry
from staffdeck_dsh.contracts.errors import OutcomeUnknown
from staffdeck_dsh.contracts.invocation import ModuleResult, Receipt
...
from staffdeck_dsh.modules.kernel import InvocationLedgerModule
...
def test_provider_ledger_invocation_start_finish_round_trip(module, db, invocation) -> None:
    ...
    assert row.approval_json == {"engine": "dsh", "snapshot_id": None, "binding_id": "t1"}
