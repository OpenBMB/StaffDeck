...
from staffdeck_dsh.contracts.invocation import InvocationContext, ModuleInvocation
from staffdeck_dsh.contracts.manifest import SlotName
from staffdeck_dsh.contracts.security import SecurityContext
from staffdeck_dsh.modules.registry import ModuleRegistry, discover_and_install, reset_registry
from staffdeck_dsh.modules.config import reset_env_snapshot as _reset_env_snapshot
from staffdeck_dsh.security.profile import Guard, reset_profile
...
def pytest_configure(config):
    # keep the live dev server's DSH out of these tests even if a developer exports DSH_ENABLED
    os.environ.setdefault("DSH_ENABLED", "false")
