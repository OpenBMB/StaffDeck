...
Provider: ``staffdeck_dsh.modules.kernel.SopDefinitionModule`` — parses the
...
from staffdeck_dsh.composition.slots import SlotDeclaration
from staffdeck_dsh.contracts.errors import PermissionDenied, SlotKindMismatch
...
from staffdeck_dsh.modules.kernel import SopDefinitionModule
