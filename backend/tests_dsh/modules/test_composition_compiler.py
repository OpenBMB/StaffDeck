...
from staffdeck_dsh.composition.compiler import DEFAULT_HOOKS, CompositionSnapshot
from staffdeck_dsh.composition.slots import sop_slots
from staffdeck_dsh.composition.staff import CapabilityBindingView, SessionPolicy, SopView, StaffComposition
from staffdeck_dsh.contracts.errors import DependencyCycle, PermissionDenied, RequiredSlotMissing, SlotNotBound
from staffdeck_dsh.contracts.manifest import HOOK_POINTS, ModuleKind, SlotName
from staffdeck_dsh.contracts.security import ResourceRef
from staffdeck_dsh.modules.kernel import CompositionCompilerModule
...
def test_manifest_composition_compiler_seal_refuses_without_hook_supplier(settings):
    ...
    from staffdeck_dsh.modules.registry import UnsatisfiedRequirement
