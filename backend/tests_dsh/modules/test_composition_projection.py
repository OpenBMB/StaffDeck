...
from staffdeck_dsh.composition.staff import DEFAULT_INTERACTIONS, SessionPolicy, StaffComposition
...
from staffdeck_dsh.modules.kernel import CompositionProjectionModule
