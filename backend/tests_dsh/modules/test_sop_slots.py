...
Provider: ``staffdeck_dsh.modules.kernel.SopSlotResolverModule`` — binds the
...
from staffdeck_dsh.composition.slots import ResolvedSlot, SlotDeclaration, sop_slots
from staffdeck_dsh.contracts.errors import PermissionDenied, RequiredSlotMissing, SlotNotBound
...
from staffdeck_dsh.modules.kernel import SopSlotResolverModule
