...
Provider: ``staffdeck_dsh.modules.builtin.DefaultInteractions`` — contributes
...
from staffdeck_dsh.composition import (
    DEFAULT_HOOKS,
...
from staffdeck_dsh.interactions.pipeline_host import DEFAULT_HANDLERS, InteractionPipelineHost, PipelineState
from staffdeck_dsh.modules.builtin import DefaultInteractions
from staffdeck_dsh.modules.registry import ModuleRegistry, UnsatisfiedRequirement, discover_and_install
