...
from staffdeck_dsh.capabilities.facade import FacadeDeps, SandboxFacade
...
from staffdeck_dsh.modules.builtin import SandboxProvider
...
def test_provider_sandbox_local_discover_artifacts(module, host, invocation, tmp_path):
    ...
    if found:  # artifact discovery is a legacy heuristic; when it reports, the shape is stable
        item = found[0]
        assert item["source"] == "dsh.workspace_discovery"
