...
from staffdeck_dsh.capabilities import facade as facade_mod
from staffdeck_dsh.capabilities.facade import FacadeDeps, ToolFacade
...
from staffdeck_dsh.modules.builtin import ToolProvider
