...
from staffdeck_harness.contracts import PermissionDenied, ResourceRef, SecurityContext
from staffdeck_harness.security import Guard, LocalPep, build_oss_local_profile
from staffdeck_harness.security.business_base import BaseAuthzClient, BaseAuthzConfig, BasePep, _Contract, _Pending, _Unavailable
...
def test_business_base_pending_is_signalled_by_reason_not_status() -> None:
    from staffdeck_harness.security.business_base import PENDING_REASON
...
def test_business_base_misconfigured_token_is_unavailable_not_denied() -> None:
    from staffdeck_harness.security.business_base import _Misconfigured
    from staffdeck_harness.security.profile import Guard
    from staffdeck_harness.contracts.errors import AuthorizationUnavailable
    from staffdeck_harness.contracts.security import SecurityProfile
...
def test_business_base_client_retries_once_and_maps_statuses() -> None:
    import httpx
    from staffdeck_harness.security.business_base import _Misconfigured, _Unavailable
...
def test_business_base_workload_flow_uses_identity_endpoints() -> None:
    import httpx
    from staffdeck_harness.security.business_base import BaseWorkload, BaseWorkloadConfig
