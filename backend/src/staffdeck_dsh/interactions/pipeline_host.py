...
from staffdeck_dsh.composition.compiler import CompositionSnapshot, HookPlan
from staffdeck_dsh.contracts.hooks import HookContext, HookDecision, merge_decisions
from staffdeck_dsh.contracts.manifest import HookPoint
from staffdeck_dsh.interactions.sop_adapter import build_slice
