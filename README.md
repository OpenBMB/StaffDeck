...
for tools, SOPs, knowledge bases, sessions and runs. Codex, PilotDeck (PD), and
other shell-capable coding agents can start with `staffdeck-api guide`.
The `staffdeck-api` command is separate from the desktop launcher below.
